        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full self-end px-4 lg:w-1/2">
            <div class="relative mt-10 lg:right-0 lg:mt-9">
              <img src="{{ asset('./img/potoorg.png') }}" alt="Muhammad Nurdinnullah" class="relative z-10 mx-auto max-w-full" />
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-1/3">
                <div class="mb-10 overflow-hidden rounded-xl bg-white shadow-lg dark:bg-slate-800">
                    <div class="aspect-w-4 aspect-h-3"> <!-- Menetapkan rasio aspek 4:3 untuk gambar -->
                        <img src="{{ asset('storage/' . $blog->image) }}" alt="{{ $blog->title }}" class="w-full h-full object-cover" />
                    </div>
                    <div class="py-8 px-6">
                        <h3>
                            <a href="/blog/{{ $blog->slug }}/show" class="mb-3 block truncate text-xl font-semibold text-dark hover:text-primary dark:text-white">{{ $blog->title }}</a>
                        </h3>
                        <p class="mb-6 text-base font-medium text-secondary">{{ Str::limit($blog->body, 100) }}</p>
                        <a href="/blog/{{ $blog->slug }}/show" class="rounded-lg bg-primary py-2 px-4 text-sm font-medium text-white hover:opacity-80">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
            @endforeach
      ...
      <div class="container">
        ...
        <div class="w-full border-t border-slate-700 pt-10">
          ...
          <p class="text-center text-xs font-medium text-slate-500">
            Dibuat dengan <span class="text-pink-500">❤️</span> oleh <a href="#" target="_blank" class="font-bold text-primary">Muhammad Nurdinnullah</a>, menggunakan
